...
const Jupiter = () => {
	...
	const getPlanetData = () => {
		axios
			.get(`https://api.le-systeme-solaire.net/rest/bodies/jupiter`, (res) => {
				res.json();
			})
				...
				<s.Info_Container>
					<s.Info_Container_Div>
						...
						<s.Info_Text>
							...
							<br />
							<p>
								At 318 times the mass of Earth, you can imagine that any passing asteroid or comet going near Jupiter has a
								big chance of being caught or diverted.
							</p>
							<br />
							<p>
								Maybe Jupiter was partly to blame for the great bombardment of small bodies that peppered our young Solar
								System early in its history, causing scars you can still see on the Moon today.
							</p>
							<br />
							<p>
								And in 1994, astronomers worldwide were treated to a rare sight: a comet, Shoemaker-Levy 9, breaking up under
